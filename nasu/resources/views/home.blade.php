    ...
    <div class="w-full max-w-md px-4 py-8 text-center">
        ...
        <div class="space-y-4 flex flex-col items-center">
            <form method="GET" action="{{ route('dashboard') }}">
                @csrf
                <button type="submit" class="border-2 border-accent shadow hover:bg-accent hover:text-primary-light text-primary-dark font-bold py-3 px-8 transition duration-300 mb-8 w-full text-base md:text-lg">
                    Entrar
                </button>
            </form>
        </div>
