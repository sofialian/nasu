...
<div class="container mx-auto px-2 sm:px-4 py-8 sm:py-6 mt-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
        <div class="lg:col-span-1 overflow-hidden w-full border-4 border-lime-500">
            <!-- Tasks Column -->
            <div class=" rounded-lg shadow-md overflow-y-auto w-full" style="scrollbar-width: none; -ms-overflow-style: none;">
                ...
                <div class="divide-y divide-gray-200 max-h-[350px]">
                    @isset($tasks)
        ...
        <div class="lg:col-span-1 overflow-hidden w-full">
            ...
            <div class="bg-gray-200 p-4 rounded-lg" style="min-height: 400px; position: relative; overflow: hidden;">
                @isset($room)
